...
const BookListTableRow = ({ props, dltFunc, detailsFunc }) => {
  const {
    _id,
    title,
    publisher,
    ...
    <tr className="w-full">
      ...
      <td className="sm:p-0">
        <div className="grid lg:grid-cols-4 sm:grid-cols-2">
          ...
          <div>
            <button
              onClick={() => detailsFunc(_id)}
              className="btn btn-primary btn-circle scale-75 hover:scale-90"
              type=""
            >
              <svg
          ...
          <div>
            <label
              ...
              htmlFor="my-modal-5"
              className="btn modal-button btn-secondary btn-circle scale-75 hover:scale-90"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                ...
                <div className="modal-box lg:w-8/12 sm:w-11/12 max-w-5xl lg:ml-60 sm:ml-0">
                  <div className="modal-action">
                    <label
                      onClick={() => setToggle(!toggle)}
                      htmlFor="my-modal-5"
                      className="btn btn-circle btn-error scale-75 hover:scale-90 -mt-10"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
          ...
          <div>
            <button
              onClick={() => dltFunc(_id)}
              className="btn btn-error btn-circle scale-75 hover:scale-90"
              type=""
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
