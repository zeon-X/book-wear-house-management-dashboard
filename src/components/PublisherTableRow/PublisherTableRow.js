...
const PublisherTableRow = ({ props, dltFunc }) => {
  ...
  return (
    <tr>
        ...
        <div className="flex items-center space-x-3">
          <div className="avatar">
            <div className="mask mask-squircle w-12 h-12">
              <img src={logo} alt="Pub Thumb" />
            </div>
          </div>
          <div>
            <div className="font-bold">{name.slice(0, 25)}</div>
      ...
      <td>
        {address.slice(0, 25)}
        <br />
        <span className="badge badge-ghost badge-sm">{email.slice(0, 25)}</span>
      </td>
